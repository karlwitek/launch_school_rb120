...
class History
  ...
  def save_move(human_move, computer_move)
    human_moves << "#{human_move.class}".downcase
    computer_moves << "#{computer_move.class}".downcase
  end
end
...
class RPSGame
  ...
  def display_move_history
    ...
    history.human_moves.each do |mv|
      print ' ' + mv
    end
    puts " "
    print "#{computer.name} chose:"
    history.computer_moves.each do |mv|
      print ' ' + mv
    end
    puts ' '
  end
  ...
  def play
    ...
    loop do
      human.choose
      computer.choose
      history.save_move(human.move, computer.move)
      display_moves
      display_winner
